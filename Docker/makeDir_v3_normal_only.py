...
#	subprocess.call("ln -s "+pathDict[sample]["T"]["R2"]+" "+outputFolder+"/"+sample+"_T/"+sample+"_T_2.fastq.gz",shell=True);
	...
	print("bash /diskmnt/Projects/Users/ysong/Projects/Fusion_hg38/hg38_Scripts/fusion_pipeline_v2.sh "+sample+"_N "+sample+"_N_1.fastq.gz "+sample+"_N_2.fastq.gz 36",file=output);
	print("tmux new -d -s "+ sample +tissue+" '"+ "bash /diskmnt/Projects/Users/ysong/Projects/Fusion_hg38/hg38_Scripts/fusion_pipeline_v2.sh "+sample+"_N "+sample+"_N_1.fastq.gz "+sample+"_N_2.fastq.gz 36" +"'",file=output1);
